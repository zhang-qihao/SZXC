  ...
  <el-container style="height: 100%">
    <el-header>
      ...
      <el-dialog title="源码展示" :visible.sync="dialogTableVisible" :modal-append-to-body="false">
        <iframe src="/static/frame/example/showpageexample/showpage2.html" frameborder="0"
                style="width: 100%;height: 400px"></iframe>
      </el-dialog>
    </el-header>
    <el-main style="height: calc(100% - 37px);overflow: auto;">
      <div class="main-content">
        <div class="main-content-inner" style="border-radius: 0.25rem">
          <base-block class="block-header-bgcolor" style="margin-top: 10px" rounded ref="exampleBlock1">
            ...
            <el-form @submit.native.prevent ref="form3" :model="form" label-width="80px" label-position="right">
              <el-row :gutter="20">
                <el-col :span="8">
                  <ef-show label="姓名" name="name" v-model="name"/>
                </el-col>
                <el-col :span="8">
                  <ef-show label="性别" name="sex" v-model="sex"/>
                </el-col>
                <el-col :span="8">
                  <ef-show label="年龄" name="age" v-model="age"/>
                </el-col>
              </el-row>
              <el-row :gutter="20">
                <el-col :span="16">
                  <ef-show label="电话号码" name="tel" v-model="tel"/>
                </el-col>
                <el-col :span="8">
                  <ef-show label="籍贯" name="place1" v-model="place1"/>
                </el-col>
              </el-row>
              <el-row :gutter="20">
                <el-col :span="24">
                  <ef-show label="联系地址" name="place2" v-model="place2"/>
                </el-col>
              </el-row>
              <el-row :gutter="20">
                <el-col :span="8">
                  <ef-show label="婚姻状况" name="marry" v-model="marry"/>
                </el-col>
                <el-col :span="8">
                  <ef-show label="名族" name="mz" v-model="mz"/>
                </el-col>
                <el-col :span="8">
                  <ef-show label="健康状况" name="health" v-model="health"/>
                </el-col>
              </el-row>
              <el-row :gutter="20">
                <el-col :span="8">
          ...
          <base-block class="block-header-bgcolor" style="margin-top: 10px" rounded ref="exampleBlock2">
            <div class="header-title" slot="title">
