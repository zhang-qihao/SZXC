    ...
    <el-header>
      ...
      <div class="header-right">
        <el-dropdown trigger="click" style="margin-left: 5px">
          ...
          <el-dropdown-menu class="button-dropdown" slot="dropdown">
            <el-dropdown-item>
              <el-button v-prevent-re-click type="primary" size="mini">保存</el-button>
            </el-dropdown-item>
            <el-dropdown-item>
              <el-button v-prevent-re-click type="danger" size="mini">删除</el-button>
            </el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
      </div>
      ...
      <el-dialog title="源码展示" :visible.sync="dialogTableVisible" :modal-append-to-body="false">
        <iframe src="/static/frame/example/formexample/form8.html" frameborder="0"
        ...
        <base-block class="out-block" rounded ref="exampleBlock2">
          ...
          <base-block rounded>
            ...
            <div v-if="form.switch1 == true">
              <el-form @submit.native.prevent class="inner-block-form" ref="form7" :model="form" label-position="top"
                       label-width="90px">
                <el-row :gutter="20">
                  <el-col :span="6">
                    <ef-text label="用户1" v-model="form.user1" :maxlength=20 :minlength=5 name="user1"
          ...
          <base-block rounded>
            ...
            <el-form @submit.native.prevent class="inner-block-form" ref="form8" :model="form"
                     label-position="top" label-width="90px">
              <el-row :gutter="20">
                <el-col :span="6">
                  <ef-text label="用户1" v-model="form.user1" :maxlength=20 :minlength=5 name="user1"
                           validationMessage="请输入用户1.validationMessage" :isRequirded="true"
