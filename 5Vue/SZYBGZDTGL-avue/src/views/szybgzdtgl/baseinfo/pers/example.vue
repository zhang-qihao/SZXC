    ...
    <basic-container>
      ...
      <el-form ref="form" :model="form" :rules="rules" label-position="top">
        <el-row :gutter="20">
          ...
          <el-col :span="8">
            <el-form-item label="aac147：" prop="aac147" :rules="rules3">
              <el-input v-model="form.aac147" placeholder="测试"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
...
import EfUpload from "/src/components/ef-element-comps/EfUpload";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        mail: [{required: true,  min: 8, max: 20,message: 'as', trigger: 'blur'}],
        phone: [{min: 8, max: 20, message: '长度在 8 到 20 个字符', trigger: 'blur'}]
      },
      rule3: {
        aac147: [{required: true,  min: 8, max: 20,message: 'as', trigger: 'blur'}]
      },
      form2: {
        tel: "",
        efFiles: [],
