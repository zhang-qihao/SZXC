...
var LocalizationService = /** @class */ (function () {
    ...
    LocalizationService.prototype.toLanguageString = function (key, defaultValue) {
        if (this.language &&
            ...
            messages_1.messages[Object.values(this)[0]] &&
            messages_1.messages[Object.values(this)[0]].hasOwnProperty(key)) {
            return messages_1.messages[Object.values(this)[0]][key];
        }
        else {
            return defaultValue;
        }
