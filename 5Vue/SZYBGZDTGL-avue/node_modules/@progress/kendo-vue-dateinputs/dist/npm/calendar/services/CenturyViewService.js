...
var ACTIONS = (_a = {},
    ...
    _a[models_1.Action.Up] = function (date) { return kendo_date_math_1.addDecades(date, -4); },
    _a[models_1.Action.Right] = function (date) { return kendo_date_math_1.addDecades(date, 1); },
    _a[models_1.Action.Down] = function (date) { return kendo_date_math_1.addDecades(date, 4); },
