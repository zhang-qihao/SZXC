...
var ACTIONS = (_a = {},
    ...
    _a[NavigationAction_1.Action.Up] = function (date) { return kendo_date_math_1.addYears(date, -4); },
    _a[NavigationAction_1.Action.Right] = function (date) { return kendo_date_math_1.addYears(date, 1); },
    _a[NavigationAction_1.Action.Down] = function (date) { return kendo_date_math_1.addYears(date, 4); },
...
var DecadeViewService = /** @class */ (function () {
    ...
    DecadeViewService.prototype.datesList = function (start, count) {
        return utils_1.range(0, count).map(function (i) { return kendo_date_math_1.addDecades(kendo_date_math_1.firstYearOfDecade(start), i); });
    };
