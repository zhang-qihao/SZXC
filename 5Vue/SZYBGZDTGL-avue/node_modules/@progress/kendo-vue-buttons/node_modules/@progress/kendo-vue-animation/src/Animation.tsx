 ...
 */
let Animation: ComponentOptions<Vue, DefaultData<{}>, 
DefaultMethods<AnimationMethods>, {}, RecordPropsDefinition<AnimationProps>> = {
    props: {
        childFactory: Object,
        className: String,
        tag: String,
    ...
    // @ts-ignore
    render(this: AnimationMethods, createElement: any): VNode {
        ...
        const parentDivClass = [
                ...
                styles['animation-container-relative'],
                className
        ];

        return (
            <div id={this.$props.id} class={parentDivClass}>
                {
