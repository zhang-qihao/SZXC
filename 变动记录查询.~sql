...
select distinct
  ...
  ADA3.AAE035 as 变更时间,
  case
    when a.ada137 = 'AC01_GW'
      then decode(ADA3.CAE059, '1', (select ADA4.ada152 from ADA4 where ADA4.ADA003 = a.ada003 and ADA4.ada181 = '姓名'), null, null, (select AAC003 from AC01_GW where AC01_GW.ac01id = a.Gwid))
    when a.ada137 = 'GW01'
      then decode(ADA3.CAE059, '1', (select ADA4.ada152 from ADA4 where ADA4.ADA003 = a.ada003 and ADA4.ada181 = '岗位名称'), null, null, (select GW003 from GW01 where GW01.GW001 = a.Gwid))
    when a.ada137 = 'KS01' 
